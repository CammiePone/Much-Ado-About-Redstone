...
Much Ado About Redstone (MAAR) is a small mod that aims to add circuits to Minecraft that would simplify otherwise complex or annoying solutions for simple problems.
